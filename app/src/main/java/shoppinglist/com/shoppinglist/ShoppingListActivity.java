...
public class ShoppingListActivity extends ActionBarActivity implements
    ...
    GoogleServicesManager mGoogleServices;

    @Override
    protected void onStart() {
        super.onStart();
        mGoogleServices = GoogleServicesManager.getInstance();
        mGoogleServices.initialize(this, this);
    }
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        final int error = connectionResult.getErrorCode();
        ...
        if (error == ConnectionResult.SERVICE_MISSING ||
            ...
            GooglePlayServicesUtil.getErrorDialog(error, this, 0);
        }
    }
}
